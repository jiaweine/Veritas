...
METHOD_ANCHORS: tuple[MethodAnchor, ...] = (
    ...
    MethodAnchor(
        key="meta_cochrane_ch10_2024",
        title="Cochrane Handbook Chapter 10: Analysing data and undertaking meta-analyses",
        authors="Deeks, Higgins, Altman, McKenzie, Veroniki",
        year=2024,
        venue="Cochrane Handbook for Systematic Reviews of Interventions",
        status="current-handbook-chapter",
        url="https://training.cochrane.org/handbook/current/chapter-10",
    ),
    MethodAnchor(
        key="meta_prediction_interval_2026",
        title="Assessing the properties of the prediction interval in random-effects meta-analysis",
        authors="Matrai, Koi, Sipos, Farkas",
        year=2026,
        venue="Research Synthesis Methods",
        status="published",
        url="https://www.cambridge.org/core/journals/research-synthesis-methods/article/assessing-the-properties-of-the-prediction-interval-in-randomeffects-metaanalysis/2AB38E25F6E8A97FBD6CD13971AAC70E",
        doi="10.1017/rsm.2025.10055",
    ),
    MethodAnchor(
        key="grim_2017",
