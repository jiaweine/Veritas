...
def _policy_fixture():
    ...
    policy = build_extraction_external_trust_policy(
        ...
        evidence_plan_sha256=_EVIDENCE_PLAN_SHA,
        trust_root=trust_root,
    )
    return policy, trust_root, execution_plan, attested_release, signed


def test_precommitted_policy_binds_plan_root_and_verified_run() -> None:
    policy, trust_root, execution_plan, attested_release, signed = _policy_fixture()
    ...
    assert receipt.evidence_plan_sha256 == _EVIDENCE_PLAN_SHA
